(function ($) {
	...
	$(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-video-popup.default', PlayBtn);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-video-banner.default', PlayBtn);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-portfolio.default', slickactivationforPortfolio);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-gallery.default', Gallery);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-counterup.default', Counterup);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-blog.default', slickactivationforPortfolio);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-agency-banner.default', Particles);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-agency-banner.default', Parallax);
        elementorFrontend.hooks.addAction('frontend/element_ready/rainbowit-main-slider.default', slickactivationforPortfolio);
    });
