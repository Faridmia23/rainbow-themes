...
use Elementor\REPEA;
use RainbowitCore\Elementor\Controls\Group_Control_RBTGradient;
...
//            [
//                'label' => esc_html__('Background Color', 'rainbowit'),
//                'type' => Controls_Manager::COLOR,
//                'selectors' => [
...
//        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Typography', 'rainbowit'),
                'selector' => '{{WRAPPER}} ' . $control_selector,
            ]
        );
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Padding', 'rainbowit'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Margin', 'rainbowit'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
    ...
    protected function rbt_section_style_controls($control_id = null, $control_name = null, $control_selector = null)
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'rainbowit'),
    ...
    protected function rbt_link_controls($control_id = 'button', $control_name = 'Button', $default = 'Read More', $default_enable = 'yes')
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Button', 'rainbowit' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Text', 'rainbowit'),
                'type' => Controls_Manager::TEXT,
                'default' => $default,
                'title' => esc_html__('Enter button text', 'rainbowit'),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Link Type', 'rainbowit'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '1' => 'Custom Link',
                    '2' => 'Internal Page',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' link', 'rainbowit'),
                'type' => Controls_Manager::URL,
                'dynamic' => [
                    'active' => true,
                ],
                'placeholder' => esc_html__('https://your-link.com', 'rainbowit'),
                'show_external' => false,
                'default' => [
                    'url' => '#',
                    'is_external' => false,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Select ' . $control_name . ' Page', 'rainbowit'),
                'type' => Controls_Manager::SELECT2,
                'label_block' => true,
    ...
    protected function rbt_link_controls_style($control_id = 'button_style', $control_name = 'Button', $control_selector = 'a', $default_size = 'btn-large', $default_style = 'rn-button-style--2 btn_solid')
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Style', 'rainbowit'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'rn-button-style--2 btn_border' => esc_html__('Outline', 'rainbowit'),
                    'rn-button-style--2 btn_solid' => esc_html__('Solid', 'rainbowit'),
                    'btn-transparent' => esc_html__('Naked', 'rainbowit'),
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Size', 'rainbowit'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'btn-size-lg' => esc_html__('Large', 'rainbowit'),
                    'btn-size-md' => esc_html__('Medium', 'rainbowit'),
                    'btn-size-sm' => esc_html__('Small', 'rainbowit'),
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Color', 'rainbowit'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'rbt-btn-theme' => esc_html__('Theme Color', 'rainbowit'),
                    'rbt-btn-dark' => esc_html__('Dark Color', 'rainbowit'),
                    'rbt-btn-gray' => esc_html__('Gray Color', 'rainbowit'),
                    'rbt-btn-white' => esc_html__('White Color', 'rainbowit'),
                ],
                'default' => 'btn-theme'
            ]
        );
        ...
        // Normal State Tab
        $this->start_controls_tab('rbt_' . $control_id . '_btn_normal', ['label' => esc_html__('Normal', 'rainbowit')]);
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Color', 'rainbowit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Box Shadow', 'rainbowit' ),
                'selector' => '{{WRAPPER}} ' . $control_selector . '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Radius', 'rainbowit'),
        ...
        // Hover State Tab
        $this->start_controls_tab('rbt_' . $control_id . '_btn_hover', ['label' => esc_html__('Hover', 'rainbowit')]);
    ...
    protected function rbt_columns_carousel($control_id = 'carousel_columns_options', $control_name = 'Select Columns', $default_for_xl = '4', $default_for_lg = '4', $default_for_md = '3', $default_for_sm = '2', $default_for_all = '1', $default_for_xs = '1'){
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Large Desktop', 'rainbowit' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1920px', 'rainbowit' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'rainbowit' ),
                    2 => esc_html__( '2 Columns', 'rainbowit' ),
                    3 => esc_html__( '3 Columns', 'rainbowit' ),
                    4 => esc_html__( '4 Columns', 'rainbowit' ),
                    5 => esc_html__( '5 Columns', 'rainbowit' ),
                    6 => esc_html__( '6 Columns', 'rainbowit' ),
                    7 => esc_html__( '7 Columns', 'rainbowit' ),
                    8 => esc_html__( '8 Columns', 'rainbowit' ),
                    9 => esc_html__( '9 Columns', 'rainbowit' ),
                    10 => esc_html__( '10 Columns', 'rainbowit' ),
                    11 => esc_html__( '10 Columns', 'rainbowit' ),
                    12 => esc_html__( '12 Columns', 'rainbowit' ),
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Desktop', 'rainbowit' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1200px', 'rainbowit' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'rainbowit' ),
                    2 => esc_html__( '2 Columns', 'rainbowit' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'rainbowit' ),
                'description' => esc_html__( 'Screen width less than 767', 'rainbowit' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'rainbowit' ),
                    2 => esc_html__( '2 Columns', 'rainbowit' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Small Mobile', 'rainbowit' ),
                'description' => esc_html__( 'Screen width less than 575px', 'rainbowit' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'rainbowit' ),
                    2 => esc_html__( '2 Columns', 'rainbowit' ),
    ...
    protected function rbt_icon_style($control_id = null, $control_name = 'Icon/Image Style', $selector = '.single-service .icon'){
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Size', 'rainbowit' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Image/SVG Width', 'rainbowit' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Image/SVG Height', 'rainbowit' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom Spacing', 'rainbowit' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
    ...
    protected function rbt_height_control($control_id = 'height', $control_name = 'Height', $selector = '.rbt-height-control'){
        $this->add_control(
            ...
            [
                ...
                'default' => 'default',
                'options' => [
                    'default' =>esc_html__( 'Default', 'rainbowit' ),
                    'full' =>esc_html__( 'Fit To Screen', 'rainbowit' ),
                    'min-height' =>esc_html__( 'Min Height', 'rainbowit' ),
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' =>esc_html__( 'Minimum '. $control_name, 'rainbowit' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 400,
                ],
