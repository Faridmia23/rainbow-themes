 ...
 * @see Walker
 */
class RainbowitNavWalker extends Walker_Nav_Menu
{
  /**
  ...
  public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
  {
    ...
    if (class_exists('acf')) {
      ...
      $enable_mega_menu       = get_field('rainbowit_enable_mega_menu', $item );
      $mega_menu_template     = get_field('rainbowit_select_mega_menu', $item );
    ...
    $mega_parent_class = (1 == $enable_mega_menu) ? 'has-megamenu position-static' : '';
    // Load post types
    ...
    $class_names = $class_names ? ' class="mainmenu-item ' . esc_attr($class_names) . '"' : '';
    ...
    if (defined('ELEMENTOR_PATH') && class_exists('Elementor\Widget_Base')) {
      if (!\Elementor\Plugin::$instance->preview->is_preview_mode()) {
        if ('' != $mega_menu_template_id && 1 == $enable_mega_menu) {
          $item_output .= '<div class="megamenu-wrapper"><div class="megamenu">' . $mega_menu_content . '</div></div>';
        }
      }
    }
